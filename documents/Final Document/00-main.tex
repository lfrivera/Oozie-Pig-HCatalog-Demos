...
\lstset {
    ...
    GROUP,FOREACH,GENERATE,MAX,STORE,INTO,INSERT,OVERWRITE,DIRECTORY,SELECT,FROM,WHERE,IN,ADD,COUNT,DUMP,AVG,CREATE,TABLE,CAST,CONCAT, ROW, FORMAT,DELIMITED,FIELDS,TERMINATED},
...
\title{Un Análisis a MapReduce, Pig, HCatalog y Oozie en términos de Atributos de Calidad}
...
\input{04-mapr-pig-hive}

\section{Pig y HCatalog}
\input{05-pig-hcatalog}

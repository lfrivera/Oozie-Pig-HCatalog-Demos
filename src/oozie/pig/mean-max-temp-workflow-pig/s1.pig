REGISTER $loadLoc;
records = LOAD '$inS1' USING com.hadoopbook.pig.CutLoadFunc('5-10,11-15,16-23,88-92,93-93') AS (usaf_id:chararray,wban_id:chararray,date:int, temperature:int, quality:int);
...
STORE  max_day_station_date INTO '$outS1';
